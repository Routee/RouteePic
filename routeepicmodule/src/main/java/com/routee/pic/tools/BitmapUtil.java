...
public class BitmapUtil {
     ...
     */
    public static String saveMyBitmap(String parentName, String filename, Bitmap bit) {
        String filePath = parentName + File.separator + filename;
    ...
    public static String compressImageUpload(String path) {
        ...
        return saveMyBitmap(Environment.getExternalStorageDirectory().getAbsolutePath(), filename, image);
    }
